      ...
      <div className="md:w-1/2 ">
        ...
        >
          {achievements.map((achievement, index) => (
            <motion.div
              key={achievement.id} // Use achievement.id as the key
            ...
            >
              <p className="text-gray-700 text-m leading-relaxed">{achievement.title}</p>
              <p className="text-gray-500 text-sm">{achievement.date}</p> {/* Render the date */}
            </motion.div>
          ))}
        </motion.div>
      </div>
